	...
	<view @touchmove.stop.prevent="clear">
		...
		<view class="popup_content">
			...
			<view class="explain_text">
				...
				<view class="line">
					你可以阅读
					<navigator :url="protocolPath" class="path" hover-class="navigator-hover">《注册协议》</navigator>和<navigator url="/pages/user/privacy-agreement/privacy-agreement" class="path" hover-class="navigator-hover">《隐私协议》</navigator>了解详细信息。如您同意，请点击"同意"开始接受我们的服务。
				</view>
			</view>
