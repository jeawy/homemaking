		...
		<view class="wrapper">
			...
			<view class="input-content">
				<view class="input-item">
					...
					<input type="number" name="mobile" v-model="loginParams.mobile" placeholder="请输入手机号码" maxlength="11" @blur="blurMobileChange" />
				</view>
				...
				<view class="input-item input-item-sms-code" v-if="!loginByPass">
					<view class="input-wrapper">
						<view class="rf-input-wrapper">
							...
							<input type="number" v-model="loginParams.code" placeholder="请输入验证码" maxlength="4" data-key="mobile" />
						</view>
